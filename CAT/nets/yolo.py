...
from nets.attention import cbam_block, eca_block, se_block, ma_block

attention_block = [se_block, cbam_block, eca_block, ma_block]
...
class YoloBody(nn.Module):
    ...
    def forward(self, x):
        ...
        #   feat1的shape为40,40,256
        #   feat2的shape为20,20,512
        # ---------------------------------------------------#
        ...
        # 20,20,256 -> 20,20,512 -> 20,20,255
        out0 = self.yolo_headP5(P5)

        # 20,20,256 -> 20,20,128 -> 40,40,128
