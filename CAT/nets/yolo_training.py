...
class YOLOLoss(nn.Module):
    def __init__(self, anchors, num_classes, input_shape, cuda, anchors_mask=[[6, 7, 8], [3, 4, 5], [1, 2, 3]],
                 label_smoothing=0):
        super(YOLOLoss, self).__init__()
        # ----------------------------------#
        # 13*13 feature map -> anchor: [81, 82], [135, 169], [344, 319]
        # 26*26 feature map -> anchor: [10, 14], [23, 27], [37, 58]
        # ----------------------------------#
